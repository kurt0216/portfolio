...
const products = [
  {
    ...
    tags:
      'Sidechain,Solidity,Typescript,EthersJs,Hardhat,Smart contract,NFT,ERC20,ERC721A,EVM,ChainBridge',
  },
  {
    title: 'Solchicks',
    description:
      'Developed NFT protocols like Breeding, Staking, Marketplace. Built bridge connecting Solana and EVM chain.',
    website: 'https://www.solchicks.io/',
    thumbnail: '/images/solchicks.png',
    tags: 'Rust,Solana,Anchor,NFT,Staking,Breeding,Bridge',
  },
  {
    title: 'Whenstaking',
    description:
    ...
    tags:
      'ReactJs,NextJs,Typescript,WaxJs,NodeJs,AWS,Lambda,S3,API Gateway,Wax blockchain',
  },
  {
    title: 'Kodadot',
    description:
